...
class Parser {
  ...
  //разбор верхнего уровня программы
    ...
    //// парсим типы и имена вида A::B::C
    ...
    bool is_assignable_expression(const AST::Expr& expr) const;     //проверка, что выражение допустимо слева от оператора присваивания
};
